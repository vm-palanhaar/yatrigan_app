...
enum IrApiUri {
  //PROD
  railStations(uri: '$baseUrlApiIrV1/stations'),
  trains(uri: '$baseUrlApiIrAppV1/trainList'),
  trainSchedule(uri: '$baseUrlApiIrAppV1/trainSchedule'),
  helpline(uri: '$baseUrlApiIrV1/helplines'),
  helplineGrp(uri: '$baseUrlApiIrV1/helplines/grp'),
...
String productDetailsUriV1 = '$baseUrlApiPcV1/prod/<pid>/';
//---ProductCatalog-DEV---
